...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto createEvent(Long userId, NewEventDto dto) {
        ...
        Category category = categoryRepository.findById(dto.getCategory())
                .orElseThrow(() -> {
                    log.warn("Категория не найдена: {}", dto.getCategory());
                    return new NotFoundException("Категория с id=" + dto.getCategory() + " не найдена");
                });
    ...
    public EventFullDto getPublicEvent(Long eventId, HttpServletRequest request) {
        String ip = request.getRemoteAddr(); // получаем IP из запроса
    ...
    private Map<Long, Long> getViewsForEvents(List<Long> eventIds) {
        ...
        try {
            ...
            List<ViewStatsDto> stats = statClient.getStats(startStr, endStr, uris, false);
